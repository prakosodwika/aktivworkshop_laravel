                                ...
                                <div
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <p class="font-semibold text-lg leading-[27px]">
                                            {{ $workshop->time_at->format('H:i A') }} - Finis
                                        </p>
                                    </div>
                    ...
                    <div class="flex flex-col rounded-3xl pt-8 gap-6 bg-white">
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <p class="font-semibold text-lg leading-[27px]">{{ $workshop->participants->count() }} Has
                                    People Joined</p>
                            </div>
                        ...
                        <div class="flex flex-col mx-8 gap-4">
                            ...
                            <div class="flex flex-col gap-6">
                                @forelse ($workshop->benefits as $itemBenefits)
                        ...
                        <div class="flex flex-col">
                            ...
                            @else
                                <a
                                    ...
                                    Workshop</a>
                                <div class="p-4 bg-aktiv-red rounded-3xl">
